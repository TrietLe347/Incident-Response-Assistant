...
const UPLOAD_SERVICE_URL =
  'https://us-central1-cs-cloud-elamin.cloudfunctions.net/upload_document';
    ...
    >
      ...
      >
        <div className="flex flex-col items-center gap-3 mb-8">
          <div
            className="w-12 h-12 rounded-xl border border-amber-500/40 flex items-center justify-center"
            style={{ background: 'rgba(245,158,11,0.08)' }}
          >
            <LockIcon />
          </div>

          <h1 className="font-mono text-slate-200 text-lg font-medium">
            Admin access
          </h1>

          <p className="text-slate-500 text-sm text-center">
            Sign in to upload policy documents
          </p>
        </div>
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-mono text-sm font-medium text-slate-200">
              ARIA Admin
            </h1>
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <h2 className="text-slate-200 text-xl font-medium mb-2">
          Upload policy documents
        </h2>

        <p className="text-slate-500 text-sm mb-8">
          PDF files uploaded here are automatically ingested,
